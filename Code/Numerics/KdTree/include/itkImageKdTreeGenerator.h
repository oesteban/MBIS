 ...
 *
 *=========================================================================*/
#ifndef __itkImageKdTreeGenerator_h
#define __itkImageKdTreeGenerator_h
 ...
 * WeightedCentroidImageKdTreeGenerator class.
 *
 ...
 * WeightedCentroidImageKdTreeGenerator
 * \ingroup ITKStatistics
 */

template< class TSample >
class ITK_EXPORT ImageKdTreeGenerator:public Object
{
public:
  /** Standard class typedefs */
  typedef ImageKdTreeGenerator            Self;
  typedef Object                     Superclass;
  typedef SmartPointer< Self >       Pointer;
  typedef SmartPointer< const Self > ConstPointer;

  /** Run-time type information (and related methods) */
  itkTypeMacro(ImageKdTreeGenerator, Object);
...
protected:
  /** Constructor */
  ImageKdTreeGenerator();

  /** Destructor */
  virtual ~ImageKdTreeGenerator() {}
...
private:
  ImageKdTreeGenerator(const Self &); //purposely not implemented
...
#include "itkImageKdTreeGenerator.hxx"
#endif
